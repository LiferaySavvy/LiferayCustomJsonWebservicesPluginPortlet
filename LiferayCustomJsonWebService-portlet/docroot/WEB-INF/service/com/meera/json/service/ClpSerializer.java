...
import com.meera.json.model.StudentClp;
...
public class ClpSerializer {
	public static final String SERVLET_CONTEXT_NAME = "LiferayCustomJsonWebService-portlet";
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(StudentClp.class.getName())) {
			...
			try {
				...
				try {
					Class<?> newModelClass = Class.forName("com.meera.json.model.impl.StudentImpl",
							true, _classLoader);
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("com.meera.json.model.impl.StudentImpl")) {
			ClassLoader contextClassLoader = Thread.currentThread()
												   .getContextClassLoader();
