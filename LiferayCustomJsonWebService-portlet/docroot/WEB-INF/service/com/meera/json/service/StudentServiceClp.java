...
public class StudentServiceClp implements StudentService {
	...
	public com.meera.json.model.Student getStudent(long studentId)
		...
		MethodHandler methodHandler = new MethodHandler(_getStudentMethodKey0,
				studentId);
	...
	private MethodKey _getStudentMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
